	...
	<div id="main" class="full-height">
		<div id="adminDash" class="w3-display-container w3-theme-l5 full-height">
			<div id="sideBar" class="side-bar w3-display-left w3-card-4">
				...
				<div class="w3-btn w3-margin-top full-length w3-left" onclick="getDonorBookingForm()">Blood Request</div>
		    	<div class="w3-btn w3-margin-top full-length w3-left" onclick="getDonorBookingForm()">Request Records</div><!--
